...
| [Событийная аналитика](Событийная аналитика) | Исследование воронки продаж в приложении, проведение А/А/В-теста | *pandas, numpy, datetime, matplotlib.pyplot, scipy, math* |
